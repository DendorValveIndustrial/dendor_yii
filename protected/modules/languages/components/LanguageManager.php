...
class LanguageManager extends CApplicationComponent {
  ...
  {
    $model = SystemLanguage::model()->findAll();
  ...
  {
    !isset($code) && $code = Yii::app()->language;
  ...
  public function setAppLanguage($lang = null)
  {
    $request = Yii::app()->request;
    !is_null($request->getParam('lang')) && $this->_lang = $request->getParam('lang');
