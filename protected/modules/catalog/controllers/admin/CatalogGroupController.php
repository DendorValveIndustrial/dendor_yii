...
class CatalogGroupController extends BaseAdminController
{
	...
	public function actionCreate()
	{
		...
		$dir = Yii::getPathOfAlias('webroot.upload.catalog');
		$this->createDir($dir);
	...
	public function actionUpdate($id)
	{
		...
		if (isset($_POST['CatalogGroup'])) {
			...
			if($model->validate())
				$dir = $dir.DIRECTORY_SEPARATOR.$model->url;
			$this->createDir($dir);
	 ...
	 * @return CatalogGroup the loaded model
	 ...
	 * @param CatalogGroup $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if (isset($_POST['ajax']) && $_POST['ajax']==='catalog-group-form') {
